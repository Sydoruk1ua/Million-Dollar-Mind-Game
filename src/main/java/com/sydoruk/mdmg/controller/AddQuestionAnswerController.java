...
import com.sydoruk.mdmg.model.Answer;
import com.sydoruk.mdmg.model.Question;
import com.sydoruk.mdmg.model.QuestionType;
...
import static com.sydoruk.mdmg.util.Validator.*;
...
/*
    ...
    private Optional<Question> getValidOptionalQuestion(HttpServletRequest request) {
        ...
        if (!isQuestionPromptEnValid(promptEn)) {
            request.setAttribute(INVALID_QUESTION_DATA, ERROR_INVALID_QUESTION_PROMPT);
            return Optional.empty();
        }
